...
class Metrics:
    ...
    def update_per_batch(self, loss, answers, pred):
        ...
        self.num_epoch += 1
        if self.topnum == 3:
            top1, top3= self.batch_accuracy_3(pred, answers)
        elif self.topnum == 10:
    ...
    def update_per_epoch(self):
        ...
        self.acc_all = self.acc_1 + self.acc_3
        

    def batch_accuracy_3(self, predicted, true):
