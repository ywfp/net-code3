...
class UD(nn.Module):
    ...
    def forward(self, v, b, q, qlen):
        ...
        w_emb = self.w_emb(q)
        # print("w_emb: ")
        # print(w_emb.size()) [128, 25, 300]
        
        # print("w_emb = {}".format(w_emb))
        q_emb = self.q_emb(w_emb)  # [batch, q_dim]
        # print("q_emb: ")
        # print(q_emb.size()) [128, 1024]

        att = self.v_att(v, q_emb) # [spa, 1]
        # print("att: ")
        # print(att.size()) [128, 36, 1]

        v_emb = (att * v).sum(1)  # [batch, v_dim]
        # print("v_emb: ")
        # print(v_emb.size()) [128, 2048]

        q_repr = self.q_net(q_emb)
        # print("q_repr: ")
        # print(q_repr.size()) [128, 1024]

        v_repr = self.v_net(v_emb)
        # print("v_repr: ")
        # print(v_repr.size()) [128, 1024]

        joint_repr = q_repr * v_repr
        # print("joint_repr: ")
        # print(joint_repr.size()) [128, 1024]
